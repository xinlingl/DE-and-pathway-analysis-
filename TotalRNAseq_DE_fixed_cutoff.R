...
for (i in 1:dim(comps)[1]) {
  ...
  print(plot.PCA(res.pca_1,axes=c(1,2),habillage=ncol(dat.norm),cex=1))
  print(plot.PCA(res.pca_1,axes=c(1,2),habillage=ncol(dat.norm),cex=2,label='none'))
  print(plot.PCA(res.pca_1,axes=c(1,3),habillage=ncol(dat.norm),cex=1))
  print(plot.PCA(res.pca_1,axes=c(1,3),habillage=ncol(dat.norm),cex=2,label='none'))
  print(plot.PCA(res.pca_1,axes=c(2,3),habillage=ncol(dat.norm),cex=1))
  print(plot.PCA(res.pca_1,axes=c(2,3),habillage=ncol(dat.norm),cex=2,label='none'))
  dev.off()
