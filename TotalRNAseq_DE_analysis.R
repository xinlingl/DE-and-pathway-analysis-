...
for (i in 1:dim(comps)[1]) {
  ...
  rmarkdown::render("Interactive_report_RNAseq.Rmd", params = list(data = a1, info = a2, comparison = a3, project = project), output_file = paste0(name, ".html"),output_dir=out_folder)
  i=i+1
};rm(i)
